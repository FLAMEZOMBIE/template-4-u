...
<!-- KALO MO BIKIN/GANTI TAMPILAN DASHBOARD BISA HAPUS AJA KODINGAN INI OKE :) -->
  ...
  data() {
    return {
      ...
      todolist: [
        {
          state: true,
          task: 'Try out the new MIMs Tasks'
        },
        {
          state: false,
        ...
        {
          state: false,
          task: 'Create MIMs Control Better'
        }
      ]
    }
  },
    ...
    firstLoginnotify() {
      ...
      if (this.$store.state.app.firstLogin === 'yep') {
        this.$notify.info({
          ...
          message: 'First login system, You can view MIMs Control documentation',
          duration: 6000,
          offset: 60
        })
